...
Se utiliza para determinar si las hardwords son palabras de diccionario, ya que el tipo particular de \textit{stemming} (Krovetz) recorta las palabras a las disponibles en diccionario.
...
\begin{enumerate}
  ...
  \item Si todo lo anterior falla, abandonar la búsqueda y dejar que \texttt{EMF} elija la expansión.
\end{enumerate}
