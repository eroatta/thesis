...
\textit{Stemming} es la primera técnica, y consiste en eliminar los sufijos de las palabras; por lo tanto, ignorando la forma particular de esa palabra remitiéndose a la raíz.
Por ejemplo: $stem(walk, walking, walk) \sets walk$.
Se utiliza para determinar con mayor acierto si las hard-words son palabras de diccionario.
