...
El token original es dividido, reemplazando los caracteres especiales y los números por espacios en blanco (línea 1).

El resultado de la ejecución de \textit{mixedCaseSplit} consiste en una serie de cadenas de caracteres delimitadas por espacios, donde cada una de estas presenta alguno de estos patrones: (a) todas minúsculas, (b) todas mayúsculas, o (c) una mayúscula seguida de todas minúsculas.
