...
Para ello se calculan los scorings tanto para el lado izquierdo como para el derecho (líneas 6 y 7) de este tentativo punto de corte.
La raíz cuadrada del scoring aplicada en distintos puntos del algoritmo tiene la finalidad de reducir el impacto del score de palabras cortas, ya que estas suelen tener mucha frecuencia y eso podría desembarcar en divisiones no relevantes, como por ejemplo \textit{per-formed} en lugar de \textit{performed}.
