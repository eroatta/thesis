...
Una división $s \in Splits(id)$ está compuesta por una serie de soft-words $s_1 s_2 ... s_n$.
Para cada soft-word $s_i$, la función $E(s_i)$ establece el conjunto de distintas expansiones $e_{i,1}, e_{i,2}, ..., e_{i,m}$ para $s_i$.
